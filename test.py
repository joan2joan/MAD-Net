...
def parse_args():
    ...
    parser.add_argument('--config', default='configs/abcnet/abcnet_clft-s_256x256_1500e_nudt.py',help='train config file path')
    parser.add_argument('--checkpoint', default='work_dirs/abcnet_clft-s_256x256_1500e_nudt/20240805_122237/best.pth.tar', help='checkpoint file')
    parser.add_argument(
        '--work-dir',
